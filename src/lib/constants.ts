...
export const NAV_LINKS = [
  ...
  },
  {
    ...
    href: "#",
    children: [
      { label: "KTU Hub", href: "/ktu" },
      { label: "2019 Scheme", href: "/ktu/2019" },
      { label: "2024 Scheme", href: "/ktu/2024" },
      { label: "2019 vs 2024", href: "/ktu/2019-vs-2024" },
      { label: "Supply Exam", href: "/ktu/supply-exam" },
      { label: "Engineering Mathematics", href: "/ktu/engineering-mathematics" },
      { label: "Series Exam", href: "/ktu/series-exam" },
      { label: "CGPA Calculator", href: "/ktu/cgpa" },
      { label: "Timetable", href: "/ktu/exam-timetable" },
      { label: "Results", href: "/ktu/results" },
      { label: "Revaluation", href: "/ktu/revaluation" },
      { label: "Previous Year Papers", href: "/ktu/previous-year-papers" },
      { label: "KTU Notes", href: "/ktu/notes-free" },
      { label: "Syllabus 2019", href: "/ktu/syllabus-2019" },
      { label: "Syllabus 2024", href: "/ktu/syllabus-2024" },
      { label: "Tuition", href: "/btech-tuition-kerala" },
    ],
  },
  {
    label: "KTU Branches",
    ...
    children: [
      ...
      { label: "2019 Civil", href: "/ktu/2019-scheme/civil" },
      { label: "2019 CS", href: "/ktu/2019-scheme/cs" },
      { label: "2019 IT", href: "/ktu/2019-scheme/it" },
      { label: "2024 EEE", href: "/ktu/2024-scheme/eee" },
      { label: "2024 ECE", href: "/ktu/2024-scheme/ece" },
      { label: "2024 Civil", href: "/ktu/2024-scheme/civil" },
      { label: "2024 Mechanical", href: "/ktu/2024-scheme/mechanical" },
      { label: "2024 IT", href: "/ktu/2024-scheme/it" },
      { label: "2024 CS", href: "/ktu/2024-scheme/cs" },
    ],
  },
  {
    label: "Company",
